  ...
  return (
    <section className="relative overflow-hidden bg-zinc-950 py-28">
      ...
      <div className="relative z-10 mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 text-center">
        {/* Scarcity badge */}
        <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-red-500/30 bg-red-500/10 px-4 py-1.5">
          <span
            aria-hidden="true"
        ...
        <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
          <a
            ...
            href={primaryCtaHref}
            className="group inline-flex items-center gap-2 rounded-xl bg-emerald-400 px-10 py-4 text-base font-bold text-zinc-950 shadow-lg shadow-emerald-500/25 transition-all duration-200 hover:-translate-y-0.5 hover:bg-emerald-300"
          >
